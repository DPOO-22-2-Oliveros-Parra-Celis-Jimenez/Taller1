...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país de un atleta (Modificación 1)");
		System.out.println("14. Salir de la aplicación\n");
	}

	/*
	 * MODIFICACIÓN 1
	 * Recibe el nombre de un atleta y luego muestra el pais de dicho atleta
	 */
	...
	private void ejecutarBuscarPaisAtleta()
	{
		...
		System.out.println("El país de " + nombreAtleta + " es: "+ nombrePais);
	}
